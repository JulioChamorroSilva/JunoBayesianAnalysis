...
kde_3v0 = KDE_2d.KDE_2d(data[args.skip:,0],data[args.skip:,3])
kde_3v0.Plot(axs[3,0])
kde_2v1 = KDE_2d.KDE_2d(data[args.skip:,1],data[args.skip:,2])
kde_2v1.Plot(axs[2,1])
kde_3v1 = KDE_2d.KDE_2d(data[args.skip:,1],data[args.skip:,3])
kde_3v1.Plot(axs[3,1])
kde_3v2 = KDE_2d.KDE_2d(data[args.skip:,2],data[args.skip:,3])
