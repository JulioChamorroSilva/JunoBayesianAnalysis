...
apc.Plot(data[:2000,0], "var_0", file_tag = args.file_tag+"_zoom")
apc.Plot(data[:,1], "var_1", file_tag = args.file_tag)
apc.Plot(data[:2000,1], "var_1", file_tag = args.file_tag+"_zoom")
apc.Plot(data[:,2], "var_2", file_tag = args.file_tag)
apc.Plot(data[:2000,2], "var_2", file_tag = args.file_tag+"_zoom")
print("Done!")
